...
function StudentsChart({
  ...
  const averageScore = Math.round(
    ((Math.round(classAverageScores?.homeworkAvgScore || 0) +
      Math.round(classAverageScores?.examAvgScore || 0) +
      Math.round(classAverageScores?.attitudeAvgScore || 0)) /
      3),
  );

  const rings = [
    {
      totalProgress: Math.round(classAverageScores?.homeworkAvgScore || 0) / 100,
    ...
    {
      totalProgress: Math.round(classAverageScores?.examAvgScore || 0) / 100,
    ...
    {
      totalProgress: Math.round(classAverageScores?.attitudeAvgScore || 0) / 100,
